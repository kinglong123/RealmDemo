...
public class StringUtil {
     ...
     *
     */
    public static String getLimitLengthString(String str, int toCount, String more) throws
            Exception {
        int reInt = 0;
        String reStr = "";
        if (str == null) return "";
    ...
    /**
     * 如果小数点后面都是0则只返回整数部分。如2.2返回2.2。    2.0返回2
     * @param d
     * @return
     */
    public static String doubleFormat(float d){
...
//            df.setRoundingMode(RoundingMode.FLOOR);
    ...
    public static String getFloatString2(float value) {
        int intValue = (int) value;
        //保留小数点后两位
        if (value == intValue) {
            return String.valueOf(intValue);
